export const SERVICES = {
  discord: { name: 'Discord', url: 'https://discord.com/app', protocol: 'discord://', color: '#8d8aff' },
  whatsapp: { name: 'WhatsApp', url: 'https://web.whatsapp.com/', protocol: 'whatsapp://', color: '#59d49b' },
  spotify: { name: 'Spotify', url: 'https://open.spotify.com/', protocol: 'spotify:', color: '#76de9b' },
...
export const WIDGETS = ['welcome', 'system', 'media', 'social', 'library', 'audio', 'network', 'clock', 'notes', 'timer', 'launchers'];
export const DEFAULTS = {
  settings: { displayId: null, displayIdentity: null, fullscreen: false, alwaysOnTop: false, autostart: false, theme: 'mint', density: 'comfortable', profile: 'command', username: '', artwork: false, reduceMotion: false },
  layouts: {
  ...
  sizes: {}, favorites: [], customGames: [], webWidgets: [], notes: '',
